	...
	<view>
		<view class="_main">
			<view class="_head">
				<view class="_left">
					<view class="_avater">
						<image v-if="userInfo.avatar" :src="userInfo.avatar" mode="widthFix" class="_avater_img">
						</image>
						<image v-if="userInfo.hot" :src="userInfo.hot" mode="widthFix" class="_hot"></image>
					</view>
					<view class="_text">
                ...
                userInfo.address
                  ...
                  :localUserInfo.address?plusXing(localUserInfo.address, 4, 4):"地址生成中..."
              }}
							<view class="_icon_copy">
								<image src="https://oss.mytrol.cn/uni_mytrol/icon/copy.png" mode=""></image>
							</view>
						</view>
					</view>
				</view>
				<view class="_right">
					...
					<view class="_t2">
						<image src="https://oss.mytrol.cn/uni_mytrol/icon/vip.png" mode=""></image>
			...
			<view class="_cont">
				<view class="_tab_list">
					<view class="_tab" v-for="(item, index) in tabList" :key="item.id" @click="changeTab(item)">
						<view class="_tit" :class="[activeTab == item.id ? '_active_tit' : '']">
							{{ item.name }}
						</view>
					...
					<!-- <view class="_redeem" @click="linkTo('/pages/redeem/redeem')">
						<view class="_icon">
							<image src="http://oss.mytrol.cn/uni_mytrol/icon/redeem_icon.png" mode=""></image>
						</view>
						<view class="_t1">
							兑换中心
						</view>
	...
	export default {
		...
		data() {
			return {
				...
				getCont: 0,
				imgUrl: 'https://mytrol-pub.oss-cn-shenzhen.aliyuncs.com/mytrol/h5WebSite/button.png'
			};
		},
		computed: {
			localUserInfo() {
