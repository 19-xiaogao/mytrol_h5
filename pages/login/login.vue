	...
	<view class="_m_login _hideScrollbar">
		<view class="right-box">
			...
			<view class="input-box">
				...
				<view class="input-phone _m_inp">
					<view>密码</view>
					<input type="password" maxlength="18" v-model="data.password" name="" placeholder="请输入密码" id=""
						@change="
              (val) => {
            ...
            " @keyup.enter="login" />
					...
					<img v-if="data.isPassword" src="https://oss.mytrol.cn/uni_mytrol/img/login/success.png"
						class="icon" alt="" />
					<img v-else src="https://oss.mytrol.cn/uni_mytrol/img/login/failed.png" class="icon" alt="" />
				</view>
				<view class="footer">
					...
					<view class="forgot-password" @click="handleRouterClick('/pages/login/retriverpassword')">
						忘记密码
					</view>
				</view>
			</view>
