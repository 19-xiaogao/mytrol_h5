<template>
  <view class="_orider_list">
    <oriderItem class="_list" v-for="(item, index) in orider_List" :NFT_item="item" :key="index"></oriderItem>

    <view class="_null_data" v-if="orider_List.length < 1">
      <view class="_null_bg">
        <image src="https://oss.mytrol.cn/uni_mytrol/icon/null_data_bg.png" mode=""></image>
      </view>
    </view>
  </view>
</template>
