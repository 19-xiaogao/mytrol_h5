<template>
	<view class="content">
		<uni-nav-bar left-img="https://oss.mytrol.cn/uni_mytrol/img/logo.png" left-img-h="29px"
			left-img-w="121px" fixed="true" color="#ffffff"
			:backgroundColor="pageKey == 'home' ? '#000000E6' : '#1C1C1C'" title=" " class="_nav_index"
			:statusBar="true"></uni-nav-bar>

		<view :style="height" v-show="pageKey == 'home'" scroll-y @scrolltolower="lower('home')">
			<Home ref="home"></Home>
		</view>
		<view :style="height" v-show="pageKey == 'main'" scroll-y @scrolltolower="lower('main')">
			<Main ref="main"></Main>
		</view>

		<sj-tab-bar v-if="tabBar.color" ref="tab_bar" :tabBar="tabBar" mode="2" @change="change">
		</sj-tab-bar>
	</view>
</template>
			...
			return {
				...
				tabBar: {
					...
					list: [{
							...
							selectedIconPath: "https://oss.mytrol.cn/uni_mytrol/icon/home_active.png",
							text: "首页",
						},

						{
							...
							selectedIconPath: "https://oss.mytrol.cn/uni_mytrol/icon/main_active.png",
							text: "个人中心",
						},
					], //tab 列表
					logo: {
